...
async function dailyWhalesDifference() {
  try {
    ...
    const range = "Hoja 5!A:E"; // Reemplaza con el rango adecuado
    ...
    const threshold = 13; // Define un umbral pequeño para considerar la diferencia
      ...
      console.log("Nueva fila agregada a la Hoja 5.");
...
export default dailyWhalesDifference;
